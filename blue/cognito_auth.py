...
from duckdown.handlers.access_control import UserMixin

LOGGER = logging.getLogger(__name__)


class CognitoHandler(
    UserMixin, RequestHandler, OAuth2Mixin
    ...
    def initialize(self):
        ...
        self._REDIRECT_URL = self.settings[self._OAUTH_SETTINGS_KEY][
            "redirect_url"
        ]
