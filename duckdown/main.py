...
def make_app():
    ...
    img_path = (
        "https://s3-eu-west-1.amazonaws.com/vashti.blueshed.info/images/"
    )

    static_path = settings.get("static_path", "static")
    template_path = settings.get("template_path", "templates")
    pages_path = settings.get("pages_path", "pages")
